...
$pad = md5($password);
if($name == 'admin' && $password == 'admin123' && !empty($name) && !empty($password)){
  $teachQuery = "SELECT * FROM authenticate WHERE username='$name' and password='$pad'";
  $qryChk= mysqli_query($conn,$teachQuery);
  $rset = mysqli_fetch_array($qryChk);
  if(is_array($rset)){
    $_SESSION['nem'] = $rset['username'];
...
<body>
    ...
    <header>
            <!----------- first navbar ------------->
            <nav class="navbar" style="border-bottom: 2px solid #ddd; background-color: white;">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a href="hotel.php" id="top" class="navbar-brand" style="font-weight: bold;">SPOTLIGHT HOTEL AND RESORT</a>
                    </div>
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                        <ul class="nav navbar-nav" style="margin-left: 40em; padding-right: 20px; font-size: 15px; font-weight: bold;">
            ...
            <!--------- second navbar ------->
        <nav class="navbar" style="margin-top: -1.5em; margin-bottom: -0.1em; border-bottom: 1px solid #ddd; background-color: white;">
                <div class="container-fluid">
                    <div class="navbar-header">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <a href="hotelreg.php"><button type="button" class="btn btn-primary" style="margin-top: 1em; margin-left: 6em;">REGISTER</button></a>
                       </div>
                 </div>
              </nav>
            </header>
	...
	<form action="adminlogin.php" method="POST">
		...
		<input type="text" name="uname" id="uname" class="form-control frm" placeholder="Your Username"><br>
		<label for="pwd" class="lab">Password:</label><br>
		<input type="Password" name="pwd" id="pwd" class="form-control frm" placeholder="Your Password"><br></div>
		<button type="submit" name="login" class="btn btn-primary">LogIn</button><br><br>
        <a href="hotellogin.php">Login as a Member</a>
	</form>
        </center>
</body>
</html>